...
return array(
        ...
        // 'runtimePath'=>'/var/wordpress/runtime/'
        ...
        wordpress developers: Set this to 2 to additionally display STRICT PHP error messages and get full access to standard templates
        */
                'debug'=>0,
                'debugsql'=>0, // Set this to 1 to enanble sql logging, only active when debug = 2
                // Update default wordpress config here
                'updatable'          => false,
